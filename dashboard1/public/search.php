...
WHERE approval=1 AND name LIKE '%$search%' OR domain LIKE '%$search%' ;";

$sql1="SELECT * FROM $sql WHERE approval=1";
...
<div class="flex justify-center flex-1 lg:mr-32">
              ...
              <button
                  class="px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" name="seacrh"
                >
                 Search
                </button>
...
<?php
 ...
 ?>
              ...
              <br>
              <p>
              <a href="viewproject.php?id=<?php echo $row['id']; ?>">
