...
$title=$_POST["title"];
$blog=$_POST["blog"];
$sql="INSERT INTO blogs(title,blogs,email)
VALUES('$title','$blog','$email')";
...
<br><br> <div
            ...
            >
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Title Of the Blog</span>
                <input
...
<br>
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Blog</span>
                <textarea cols="100px" rows="20"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
