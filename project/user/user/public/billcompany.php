            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="cash.php">Cash</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="cheque.php">
                      Cheque
                    </a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="online.php">
                      Online
                    </a>
                  </li>
                ...
                >
                  ...
                  <template x-if="dark">
                    ...
                    >
                      <path
                        fill-rule="evenodd"
                        d="M10 2a1 1 0 011 1v1a1 1 0 11-2 3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z"
                        clip-rule="evenodd"
                      ></path>
                    </svg>
                  </template>
...
<?php if($value=="1"){ ?>
    ...
    <form action="transactcompanycash.php" method="POST">
<label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">Amount</span>
                <input 
                  class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                  rows="3"
                  placeholder="Amount in Rs" required name="amount"
                >
                <br>
              </label>
              <div>
              ...
              <input type="hidden" value="clients" name="type">
...
?>
<br>
<h2 style="color: red; text-align:center;">Enter the cheque Details</h2>

<form action="transactcompanycheque.php" method="POST">
    <label class="block mt-4 text-sm">
    <span class="text-gray-700 dark:text-gray-400">Cheque Number</span>
    <input 
      class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
      rows="3"
      placeholder="Cheque number" required name="chequenum"
    >
  ...
  <label class="block mt-4 text-sm">
    <span class="text-gray-700 dark:text-gray-400">Cheque Date</span>
    <input 
      class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
      rows="3"
      placeholder="Cheque number" required type="date" name="chequedate"
    >
  ...
  <label class="block mt-4 text-sm">
    <span class="text-gray-700 dark:text-gray-400">Cheque Amount</span>
    <input 
      class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
      rows="3"
      placeholder="Cheque amount" required name="chequeamount"
    >
  ...
  <label class="block mt-4 text-sm">
    ...
    <input 
      class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
      rows="3"
      placeholder="bank name" required name="bank"
    >
...
<form action="transactcompanyonline.php
" method="POST">
<br><br>
<label class="block mt-4 text-sm">
      <span class="text-gray-700 dark:text-gray-400">Transaction Number</span>
      <input 
        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
        rows="3"
        placeholder="transaction number" required name="trnumber"
      >
...
<label class="block mt-4 text-sm">
      <span class="text-gray-700 dark:text-gray-400">Transaction Date</span>
      <input 
        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
        rows="3"
        placeholder="transaction number" required name="trdate" type="date"
      >
</label>
...
<label class="block mt-4 text-sm">
      <span class="text-gray-700 dark:text-gray-400">Transaction Amount</span>
      <input 
        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
        rows="3"
        placeholder="transaction amount" required name="amount" 
      >
</label>
...
<label>
                    &nbsp;<input
                      ...
                      value="Googlepay"
                    />
                    <span class="ml-2">Googlepay</span>
                  </label>
                  <label
...
<br><br>
                <img src="https://projects.lotusglobalservices.com/project/admin/public/image/<?php
 echo $upi;
