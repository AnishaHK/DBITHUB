              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="login.php">Cash</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
...
<label class="block text-sm">
  ...
  <input
    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
    placeholder="name of the person(contact)" name="contact" required
  />
</label>
...
<label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Whatsapp number</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="whatsapp number...."  name="whatsapp" required
                />
              </label>
<br>
...
$sql="INSERT INTO  client(name,contactname,address,city,pincode,pnumber,whatsapp,landline,email,gst) VALUES('$name','$contact','$adress','$city','$pincode','$pnumber','$whatsapp','$landline','$email','$gst')";
