...
<label class="block text-sm">
  ...
  <input
    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
    placeholder="90******" name="whatsapp" required
  />
</label>
...
<br>
              ...
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">UPI QR CODE</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="password" type="file" name="uploadfile" required
                />
              </label>
...
$sql="INSERT INTO  users(fname,lname,pnumber,emailid,password,upi) VALUES('$fname','$lname','$whatsapp','$email','$password','$filename')";
